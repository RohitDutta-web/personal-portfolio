    ...
    <>
      <div className="mt-16  items-center flex flex-col">
        ...
        <div className="w-2/3 ">
          ...
          <div className="ml-5">
            <button className="border-2 pt-2 pb-2 pl-5 pr-5 rounded-3xl text-green-400 text-xl font-bold hover:opacity-100 hover:bg-green-400 hover:bg-opacity-20 border-green-400 opacity-70  mr-5 mt-5">Contact</button>
            <button className="border-2 pt-2 pb-2 pl-5 pr-5 rounded-3xl text-green-400 text-xl font-bold hover:opacity-100 hover:bg-green-400 hover:bg-opacity-20 border-green-400 opacity-70  mr-5 mt-5">Resume</button>
          </div>
        </div>
